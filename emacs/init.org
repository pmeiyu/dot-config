...
*** Font
    #+begin_src emacs-lisp
      (defun my-font-available-p (font &optional frame)
        "Detect if the FONT is available."
        (if (find-font (font-spec :family font) frame)
            t
          nil))

      (defun my-set-font (font-list &optional font-size frame)
    ...
    #+begin_src emacs-lisp
      (defun my-set-font-for-frame (frame)
        (when (display-graphic-p)
          (my-set-font '("DejaVu Sans Mono" "Monospace") nil frame)))
...
** Chinese Font
   ...
   #+begin_src emacs-lisp
     (defun my-set-chinese-font (font-list &optional font-size frame)
   ...
   My preferred fonts
   #+begin_src emacs-lisp
     (defun my-set-chinese-font-for-frame (frame)
       (when (display-graphic-p)
     ...
     (add-hook 'after-make-frame-functions 'my-set-chinese-font-for-frame)
   #+end_src
